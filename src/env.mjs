...
export const env = createEnv({
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_SOLANA_DEVNET_ENDPOINT: process.env.NEXT_PUBLIC_SOLANA_DEVNET_ENDPOINT,
    ...
    NEXT_PUBLIC_OPOS_GAME_MASTER_KEY: process.env.NEXT_PUBLIC_OPOS_GAME_MASTER_KEY,
