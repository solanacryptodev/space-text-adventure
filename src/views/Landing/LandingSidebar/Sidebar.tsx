...
export const LandingSidebarView = observer((): JSX.Element => {
  return (
    ...
    >
      <div className="overflow-y-auto py-5 px-3 h-full bg-[#1f2933] dark:bg-gray-800">
        <form action="#" method="GET" className="md:hidden mb-2">
          ...
          <div className="relative">
            <div className="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
              <svg
                className="w-5 h-5 text-white-400 dark:text-gray-400"
                fill="currentColor"
                viewBox="0 0 20 20"
      ...
      {/* Footer Area */}
      <div className="hidden absolute bottom-0 left-0 justify-center p-4 space-x-4 w-full lg:flex bg-[#1f2933] dark:bg-gray-800 z-20">
        <a
          href="#"
          className="inline-flex justify-center p-2 text-gray-500 rounded cursor-pointer dark:text-gray-400 hover:bg-black dark:hover:text-white dark:hover:bg-gray-600"
        >
          <svg
            aria-hidden="true"
            className="w-6 h-6"
        ...
        <a
          ...
          className="inline-flex justify-center p-2 text-gray-500 rounded cursor-pointer dark:text-gray-400 dark:hover:text-white hover:text-gray-900 hover:bg-black dark:hover:bg-gray-600"
        >
          <svg
            aria-hidden="true"
            className="w-6 h-6"
